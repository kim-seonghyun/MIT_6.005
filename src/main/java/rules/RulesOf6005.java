...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if(!writtenAsCourseWork && availableToOthers && !writtenAsCourseWork && !citingYourSource && !implementationRequired){
            return false;
        }

        if (writtenByYourself && !availableToOthers && writtenAsCourseWork && citingYourSource
